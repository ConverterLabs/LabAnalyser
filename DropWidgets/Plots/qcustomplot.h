...
public:
  ...
  */
  ...
  void SetXYPlot(bool enabled){mXYPlot = enabled;}
  bool XYPlot(){return mXYPlot;}

  void SetBlockUpdates(){mBlockDataUpdate = true;}
  void UnblockUpdates(){mBlockDataUpdate = false;}

  bool IsUpdateBlocked(){return mBlockDataUpdate;}
...
public:
  ...
  */
  ...
  boost::shared_ptr<std::vector<double>> GetYDataPointer(){return DataPointerY; }
  boost::shared_ptr<std::vector<double>> GetXDataPointer(){return DataPointerX; }
  boost::shared_ptr<std::vector<double>> GetYFFTPointer(){return DataFFTY; }
  boost::shared_ptr<std::vector<double>> GetXFFTPointer(){return DataFFTX; }
  // setters:
 // void setData(QCPDataMap *data,const std::set<double,QMap::iterator> &WrapperSetI, bool copy=false);

  void setData( boost::shared_ptr<std::vector<double>> key,  boost::shared_ptr<std::vector<double>> value, double Xoffset_);
  void setFFTData( boost::shared_ptr<std::vector<double>> key,   boost::shared_ptr<std::vector<double>> value);
  ...
  void SetXYPlot(bool enabled){mXYPlot = enabled;}
  bool XYPlot() const {return mXYPlot;}
...
protected:
  ...
  boost::shared_ptr<std::vector<double>> DataPointerX;
  boost::shared_ptr<std::vector<double>> DataPointerY;
  boost::shared_ptr<std::vector<double>> DataFFTX;
  boost::shared_ptr<std::vector<double>> DataFFTY;
  double XOffset;
  ...
  void getFFTPlotData(QVector<QPointF> *lineData, QVector<QCPData> *pointData) const;
