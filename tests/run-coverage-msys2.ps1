...
try {
    ...
    $vendoredSource = 'DropWidgets/Plots/qcustomplot.cpp'
    $productionSources = @(
    ...
    $markdown.Add('')
    $markdown.Add('- Excluded vendored code: `DropWidgets/Plots/qcustomplot.cpp`.')
    ...
    [PSCustomObject]@{
        ...
        Excluded = @('DropWidgets/Plots/qcustomplot.cpp', 'generated Qt/build sources', 'tests/**')
        Totals = $totals
        Files = $rows
